...
namespace L069
{
    public class WxSessionList
    {
        ...
        public void GetData()
        {
            ...
            int linkPointer = GetWxMemoryInt(wxProcess.Handle, weChatBaseAdress + roomLinkOffset) + 0x1E0 + 0x64;
...
//$+10 > 03B531F8 UNICODE "10341227304@chatroom"
//$+14 > 00000014
//$+18 > 00000020
            ...
            Console.WriteLine("联系人/群wxid：\t" + contractWxId);

            //$+24 > 0E605B10 群名
            int nickNameAddress = GetWxMemoryInt(wxProcess.Handle, roomAddress + 0x24);
            //Console.WriteLine("群名地址：\t" + nickNameAddress);
            //$ ==>    > 00000000
            //$+4 > 03B52BB8 UNICODE "10341227304@chatroom"
            //$+8 > 00000014
            //$+C > 00000020
            //$+10 > 00000000
            //$+14 > 00000000
            //$+18 > 098BF590 UNICODE "A【慧德教育微课堂】389班"
            //$+1C > 0000000E
            //$+20 > 00000010
            String nickName = GetWxMemoryUnicodeString(
                wxProcess.Handle,
                GetWxMemoryInt(wxProcess.Handle, nickNameAddress + 0x18),
                GetWxMemoryInt(wxProcess.Handle, nickNameAddress + 0x1C)
                );
            Console.WriteLine("昵称/群名：\t" + nickName);
